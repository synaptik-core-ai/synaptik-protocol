...
3. Systems MAY use cryptographic or other tamper-detection mechanisms to verify graph integrity
4. If causal metadata is altered, systems MUST invalidate dependent integrity proofs

**Non-Normative Note:** Various cryptographic and non-cryptographic approaches exist for protecting graph integrity. Implementation choices depend on threat model and performance requirements. See commercial and research implementations for specific techniques.
...
- Parent fingerprints can create tamper-evident chains
- Graph structures can provide provenance verification
- Causal traversal enables verifying full dependency chains

Systems MAY use causal structure to detect retroactive tampering (if parent fingerprints don't match, causality was corrupted).
...
**Non-Normative Note:** Various advanced implementations exist that combine causal provenance with cryptographic integrity mechanisms, control-theoretic monitoring, and other features. Consult commercial and research implementations for specific integration patterns.
